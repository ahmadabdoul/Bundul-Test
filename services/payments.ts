...
export type Payment = {
  ...
  export const MOCK_PAYMENTS: Payment[] = [
    { id: 3, service: 'Spotify', amount: 14.99, dueDate: '2025-10-19', currency: 'USD', icon: require('../assets/images/icons/spotify-icon.png') },
    { id: 1, service: 'Netflix', amount: 29.99, dueDate: '2025-10-19', currency: 'USD', icon: require('../assets/images/icons/netflix.png') },
    { id: 2, service: 'Apple One', amount: 9.99, dueDate: '2025-10-21', currency: 'USD', icon: require('../assets/images/icons/apple-icon.png') },
